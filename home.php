		...
		<div class="main-nav-container">
								...
								<div class="dropdown-menu bg-purple">
									<?php
										...
										if(mysqli_fetch_assoc(mysqli_query($conn, $sql))['role'] == 0){
											?>
											<a class="nav-link text-dark decor" href="./admin.php?id=<?php echo $_GET['id']?>">
												<i class="fa-sharp fa-solid fa-user-tie"></i> Admin</a>
											<?php
										}
									?>
									<a class="nav-link text-dark decor" href="./profile.php?id=<?php echo $_GET['id']?>">
										<i class="fa-sharp fa-solid fa-user-tie"></i> Profile</a>
									<a class="nav-link text-dark decor " href="./history_order.php?id=<?php echo $_GET['id']?>">
			...
			<div class="header-with-search">
				...
				<div class="account-nav border-center">
					<a href="./shopcart.php?id=<?php echo $_GET['id'];?>" style="text-decoration: none; color: inherit; font-size: 150%;">
			...
			<div class="row members-list">
				<?php
					...
					while($row = mysqli_fetch_assoc($result)){
						?>
						<form class="col-6 col-sm-4 .col-md-1 col-lg-4 mb-5" method="POST" action="./order.php?id=<?php echo $_GET['id']?>">
							<div class="card ">
