                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($result)){
                                            ...
                                            <td><button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='./delete_order.php?id=<?php echo $_GET['id'];?>&id_order=<?php echo $row['id_order'];?>&from=0';">Delete</button></td>
                                            </tr>
                                            <?php
                                        }
                                    ?>
