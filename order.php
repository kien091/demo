...
<body>
    ...
    <?php
        ...
        while($row = mysqli_fetch_assoc(mysqli_query($conn, $sql))){
            ...
            $note = $row['note'];
            ?>
            <form action="./handle_order.php?id=<?php echo $_GET['id']?>" method="POST">
                <div class="container">
                    <div class="container">
                        ...
                        <div class="card card-item mb-5">
                            <div class="row">
                                ...
                                <div class="col-lg-6 bg-gray">
                                    ...
                                    <div class="form-outline">
                                        <input type="text" id="form3Examplea2" class="form-control form-control-lg" name="note"/>
                                        <label class="form-label" for="form3Examplea2">Enter your
                                            Note</label>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            value="<?php echo $id_product?>" name="submit">Buy Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
